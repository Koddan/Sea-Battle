...
<body>
<!-- Yandex.Metrika counter --> <script src="views/usersCreateTable.js" type="text/javascript" > (function (d, w, c) { (w[c] = w[c] || []).push(function() { try { w.yaCounter45744036 = new Ya.Metrika({ id:45744036, clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); } catch(e) { } }); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = "https://mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex_metrika_callbacks"); </script> <noscript><div><img src="https://mc.yandex.ru/watch/45744036" style="position:absolute; left:-9999px;" alt="" /></div></noscript><!-- /Yandex.Metrika counter -->
...
";"+Math.random();</script><!--/LiveInternet-->
  <div class="battlefield">
    ...
    <div class="outer clearfix">
      ...
      <div id="instruction" class="instruction" data-hidden="false">
        <div id="type_placement" class="type-placement-box">
          1. <span class="link" data-target="random">At random</span><br>
          2. <span class="link" data-target="manually">By himself</span>
        </div>
        <div id="ships_collection" class="ships-collection" data-hidden="true">
          <p>Drag and drop the ships onto the playing field. To install the ship vertically, right-click on it.</p>
    ...
    <!-- нижний блок для вывода текстовых сообщений -->
